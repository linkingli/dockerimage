...
docker tag registry.cn-hangzhou.aliyuncs.com/lilisi/ttg:kraken-origin gcr.io/uber-container-tools/kraken-origin:v0.1.1
docker tag registry.cn-hangzhou.aliyuncs.com/lilisi/ttg:kraken-build-index gcr.io/uber-container-tools/kraken-build-index:v0.1.1
docker tag registry.cn-hangzhou.aliyuncs.com/lilisi/ttg:kraken-agent gcr.io/uber-container-tools/kraken-agent:v0.1.1
```
